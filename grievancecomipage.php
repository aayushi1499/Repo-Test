...
if (!isset($_SESSION['USERNAMEC'])){
       header('Location:committeelogin.php');
     }
 ...
 <html lang="en">
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
     ...
     <div class="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <ul class="navbar-nav">
           <form class="form-inline" action="../process/committeelogin.php" method="post">
   ...
   <body>
    ...
    <div class="container-fluid">
      <?php require 'sub-views/committeesidenav.php'; ?>
                 ...
                 <div class="row">
                   <div class="col-lg-6 col-sm-12">
                       ...
                       <div class="form-group">
                         ...
                         <a href="grievanceimagecommittee.php?id=<?php echo $value['id'];?>" class="btn btn-info">View</a>
                       </div>
                       <div class="form-group">
                       ...
                       <hr>
                       <form class="form-inline" action="../process/grievanceprocessC.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <button class="btn btn-info my-2 my-sm-0" type="submit"name="responce">Submit</button>
                      </form>
