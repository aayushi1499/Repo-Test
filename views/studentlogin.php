    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-6 col-sm-12">
        <div class="card panel">
          ...
          <div class="card-body">
            <form action="../process/studentlogin.php" method="post" autocomplete="off">
              <div class="form-group">
                <label for="">Email</label>
                <input class="form-control" type="text" name="StudentEmail" required  placeholder="Enter a Email">
              </div>
              <div class="form-group">
              ...
              <div class="text-center">
                ...
                <br>
                <a href="studentregi.php">Create an account.</a>
              </div>
